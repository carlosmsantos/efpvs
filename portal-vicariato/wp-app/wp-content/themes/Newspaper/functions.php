...
/* Função que força a tela de login do wordpress utilizar o css do tema
function custom_login_css() {
echo '<link rel="stylesheet" type="text/css" href="'.get_stylesheet_directory_uri().'/style.css"/>';
}
add_action('login_head', 'custom_login_css'); */

/* Função que altera a URL, trocando pelo endereço do site na página de login */
function my_login_logo_url() {
return get_bloginfo( 'url' );
}
add_filter( 'login_headerurl', 'my_login_logo_url' );
 
/* Função que adiciona o nome do site, no momento que o mouse passa por cima da logo na página de login */
function my_login_logo_url_title() {
return 'Paróquia Nossa Senhora de Fátima';
}
